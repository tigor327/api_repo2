...
describe("adding a new customer", () => {
  ...
  it("customer name must not contain invalid chars", () => {
    ...
    expect(() =>
      makeCustomer(customer).toThrow("Invalid chars aren't allowed as name")
    );
  });
  ...
  it("contact information must not be blank", () => {
    ...
    expect(() =>
      makeCustomer(customer).toThrow("Please enter contact information")
    );
  });
...
describe("updating customer information", () => {
  ...
  it("must not update name with special chars", () => {
    ...
    expect(() =>
      updateCustomer(customer).toThrow("Invalid chars aren't allowed as name")
    );
  });

  it("must not update with blank contact information", () => {
    const customer = { fullname: "Agram Ulis", contact: " ", address: "Lagao" };
    expect(() =>
      updateCustomer(customer).toThrow("Please enter contact information")
    );
  });
